...
from .loss import ClipLoss, DistillClipLoss, CoCaLoss, SigLipLoss, RoFLoss, RoFSigLipLoss, Clip_DALoss
...
def create_model(
    ...
    if checkpoint_path:
        ...
        # print(f'Loading full pretrained weights from: {checkpoint_path}')
...
def create_loss(args):
    if args.distill:
        ...
        world_size=args.world_size,
        use_horovod=args.horovod,
        distill_rof=args.distill_rof,
        dtm_loss_weight=args.wdtm,
        dcm_loss_weight=args.wdcm,
        dense_loss_weight=args.wdense,
        M=args.M,
        margin=args.margin,
        alpha=args.alpha
