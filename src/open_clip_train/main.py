...
from open_clip_train.mapping import MappingLayer, RobustProjector
...
def main(args):
    ...
    for epoch in range(start_epoch, args.epochs):
        ...
        train_one_epoch(model, data, loss, epoch, optimizer, scaler, scheduler, dist_model, [resizer_s, resizer_t], args, tb_writer=writer)
